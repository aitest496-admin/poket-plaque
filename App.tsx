  ...
  const renderContent = () => {
          ...
          >
            ...
            >
              ...
              {isCompareMode && compareTargetDates.map(date => {
                ...
                // For printing, we force full view or similar layout
                const viewData = dataForDate; // or filter if needed
    ...
    return (
      <div className="w-full h-full flex items-center justify-center gap-1 relative max-w-7xl mx-auto print:hidden">
        ...
        {measurementMethod !== '1-point' && showLeftControls && (
        ...
        <div className="flex-1 h-full overflow-hidden relative border border-slate-200 bg-slate-50 rounded-lg shadow-inner">
          {measurementMethod === '1-point' ? (
            ...
            >
              <div className="w-1/2 h-1/2 flex items-center justify-start bg-slate-100 p-1 pr-1">
                <div className="bg-white p-1 rounded-lg shadow-sm border border-slate-200 w-full h-full flex flex-col justify-center overflow-hidden">
              ...
              <div className="w-1/2 h-1/2 flex items-center justify-end bg-slate-100 p-1 pl-1">
                <div className="bg-white p-1 rounded-lg shadow-sm border border-slate-200 w-full h-full flex flex-col justify-center overflow-hidden">
                  <div className="flex justify-between w-full h-full gap-[1px] items-start">
                    <SideLabels jaw="upper" />
        ...
        {
          measurementMethod !== '1-point' && showRightControls && (
            <div className="flex flex-col gap-2 z-20 shrink-0 w-10 self-center">
              {isLower && (
                <button
                  onClick={goUp}
