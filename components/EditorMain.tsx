...
const EditorMain: React.FC<EditorMainProps> = ({
    ...
    const showLeftControls = (currentQuadrant === 'UR' || currentQuadrant === 'LR');
    const showRightControls = (currentQuadrant === 'UL' || currentQuadrant === 'LL');
                    ...
                    <div className="flex flex-col gap-2">
                        {showLeftControls && (
                            <>
                                ...
                                <button
                                    onClick={goLeft}
                                    className={`w-10 h-24 flex items-center justify-center bg-blue-600 text-white rounded-md shadow-md hover:bg-blue-700 active:bg-blue-800 transition-opacity duration-300 opacity-100`}
                                    aria-label="Go Left"
                                >
                                    <Icons.ArrowLeftIcon />
                                </button>
